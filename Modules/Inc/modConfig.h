...
typedef struct {
	...
	uint16_t	MaxChargingVoltage; //  max voltage, current, and charging allowed added by Evan Ryan to control the charging heartbeat message
	uint16_t	MaxChargingCurrent;
	bool		ChargingDisallowed;																										// Humidity sensor IC type
