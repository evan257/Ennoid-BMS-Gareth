...
// Added by Gareth on 2/3/2024
// Tells code to skip cell 6 and read an additional cell at the top to back fill.
// This is for segment boards with fewer than the alloted cells inorder to allow balancing of the muxed ADC channels. 
